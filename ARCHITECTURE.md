...
Public webpage text and YouTube captions enter through the same document boundary. URL validation rejects credentials, local hosts, non-public IP addresses, unsafe redirects, oversized responses, and unsupported content types. Extracted content is stored with source provenance and explicitly marked as untrusted before normal chunking, retrieval, citation, and debate processing.
